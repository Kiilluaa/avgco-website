    ...
    <main className="flex-1 bg-neutral-950 text-white">
      <section className="mx-auto flex max-w-6xl flex-col items-center px-6 py-24 text-center">
        ...
        <p className="mt-7 max-w-2xl text-lg leading-8 text-neutral-400">
          Play original browser games, and explore new
        ...
        <div className="mt-10 flex flex-col gap-4 sm:flex-row">
          ...
          <Link
            href="/weekly-games"
            className="group relative inline-flex items-center justify-center overflow-hidden rounded-full bg-linear-to-br from-cyan-500 to-emerald-500 p-0.5 font-medium text-white focus:outline-none focus:ring-2 focus:ring-blue-400"
          >
            <span className="relative rounded-full bg-neutral-950 px-7 py-3 transition-all duration-200 group-hover:bg-transparent">
              Weekly Games
            </span>
